...
export const whopSdk = WhopServerSdk({
	...
	appId: requireEnvVar("NEXT_PUBLIC_WHOP_APP_ID"),

	// Add your app api key here - this is required.
	// You can get this from the Whop dashboard after creating an app section.
	appApiKey: requireEnvVar("WHOP_API_KEY"),
	...
	onBehalfOfUserId: optionalEnvVar("NEXT_PUBLIC_WHOP_AGENT_USER_ID"),
	...
	companyId: optionalEnvVar("NEXT_PUBLIC_WHOP_COMPANY_ID"),
});
